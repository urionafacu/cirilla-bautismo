...
3. Si hay cambios, ejecuta en este orden:
   ...
   - Si no hay argumentos, crea un mensaje de commit breve y claro en espanol basado en los cambios y usalo en `git commit -m "..."`.
   - `git push origin main`
4. Si `git commit` falla por no tener cambios confirmables, explica el motivo de forma simple y no tecnica.
